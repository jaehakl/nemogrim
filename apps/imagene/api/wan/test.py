...
HIGH = Path(r"E:\ai_models\wan\high_noise_model\wanVideo22_i2vHighNoise14BFp8Sd.safetensors")
LOW  = Path(r"E:\ai_models\wan\low_noise_model\wanVideo22_i2vLowNoise14BFp16.safetensors")

# 듀얼 노이즈 ckpt_dir 준비
CKPT = prepare_dual_noise_ckpt_dir(
    model_root=Path(r"E:\ai_models\wan"),
